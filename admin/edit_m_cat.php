...
<?php 
    ...
    if(isset($_GET['edit_m_cat'])){
        ...
        $edit_m_cat_id = $_GET['edit_m_cat'];
        
        $edit_m_cat_query = "SELECT * from menu_categories where m_cat_id='$edit_m_cat_id'";
        
        $run_edit = mysqli_query($conn,$edit_m_cat_query);
        ...
        $m_cat_desc = $row_edit['m_cat_desc'];
                ...
                <form action="" class="form-horizontal" method="post"><!-- form-horizontal begin -->
                    ...
                    <div class="form-group"><!-- form-group begin -->
                        ...
                        <div class="col-md-6"><!-- col-md-6 begin -->
                            ...
                            <textarea type='text' name="m_cat_desc" class="form-control"><?php echo $m_cat_desc; ?></textarea>
...
<?php  
          ...
          if(isset($_POST['update'])){
              ...
              $m_cat_desc = $_POST['m_cat_desc'];
              
              $update_m_cat = "UPDATE menu_categories set m_cat_title='$m_cat_title',m_cat_desc='$m_cat_desc' where m_cat_id='$m_cat_id'";
              
              $run_m_cat = mysqli_query($conn,$update_m_cat);
