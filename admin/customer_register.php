...
if(isset($_POST['register'])){
  ...
  $insert_customer = "INSERT into customer (cust_firstname,cust_lastname,cust_middlename,cust_province,cust_city,cust_brgy,cust_zipcode,cust_contactNo,cust_email,cust_username,cust_password,cust_image,cust_ip) values ('$c_fname','$c_lname','$c_mname','$c_province','$c_city','$c_brgy','$c_zipcode ','$c_contact','$c_email','$c_username ','$c_cpassword','$c_image ','$c_ip') ";
