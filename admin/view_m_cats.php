                        ...
                        <tbody><!-- tbody begin -->
                            ...
                            <?php 
                                ...
                                while($row_m_cats=mysqli_fetch_array($run_m_cats)){
                                    ...
                                    $m_cat_desc = $row_m_cats['m_cat_desc'];
                            ...
                            <tr><!-- tr begin -->
                                ...
                                <td width="300"> <?php echo $m_cat_desc; ?> </td>
                                <td> 
                                    <a href="index.php?edit_m_cat=<?php echo $m_cat_id; ?> ">
                                        <i class="fa fa-pencil"></i> Edit
                                    </a>
                                </td>
                                <td> 
                                    <a href="index.php?delete_m_cats= <?php echo $m_cat_id; ?> ">
