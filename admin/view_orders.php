                        ...
                        <tbody><!-- tbody begin -->
                            ...
                            <?php 
                                ...
                                while($row_order=mysqli_fetch_array($run_orders)){
                                    ...
                                    $get_products = "SELECT * from menu where menu_id='$product_id'";
                                    
                                    $run_products = mysqli_query($conn,$get_products);
                                    
                                    $row_products = mysqli_fetch_array($run_products);
                                    
                                    $product_title = $row_products['menu_title'];
                                    
                                    $get_customer = "SELECT * from customer where cust_id='$c_id'";
