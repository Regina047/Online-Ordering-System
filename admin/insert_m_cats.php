                ...
                <form action="" class="form-horizontal" method="post"><!-- form-horizontal begin -->
                    ...
                    <div class="form-group"><!-- form-group begin -->
                        ...
                        <div class="col-md-6"><!-- col-md-6 begin -->
                            ...
                            <textarea type='text' name="m_cat_desc" id="" cols="30" rows="10" class="form-control"></textarea>
...
<?php  
          ...
          if(isset($_POST['submit'])){
              ...
              $insert_m_cat = "INSERT into menu_categories (m_cat_title,m_cat_desc) values ('$m_cat_title','$m_cat_desc')";
              
              $run_m_cat = mysqli_query($conn,$insert_m_cat);
